...
if (!checkrights("D") || !defined("iAUTH") || $aid != iAUTH) fallback("../index.php");
...
<td align='right' width='100' class='tbl'><a href='".FUSION_SELF.$aidlink."&amp;step=edit&amp;download_cat_id=".$data['download_cat_id']."&amp;download_id=".$data2['download_id']."'>".$locale['503']."</a> -
<a href='".FUSION_SELF.$aidlink."&amp;step=delete&amp;download_cat_id=".$data['download_cat_id']."&amp;download_id=".$data2['download_id']."' onClick='return DeleteItem()'>".$locale['504']."</a></td>
</tr>\n";
				}
				echo "</table>
</div>
...
<td align='center'><br>
".$locale['506']."<br><br>
<a href='download_cats.php".$aidlink."'>".$locale['507']."<br><br></td>
</tr>
</table>\n";
	}
	closetable();
...
".$locale['509']."<br><br>
<a href='download_cats.php".$aidlink."'>".$locale['510']."</a>".$locale['511']."</center>\n";
	closetable();
}
