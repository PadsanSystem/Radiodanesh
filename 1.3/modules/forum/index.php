...
<td align='center' width='5%' class='tbl2'>".$locale['402']."</td>
<td align='center' width='5%' class='tbl2'>".$locale['403']."</td>
...
<td width='65%' class='tbl1'><a href='viewforum.php?forum_id=".$data['forum_id']."'>".$data['forum_name']."</a><br>
<span width='100%'class='small'>".$data['forum_description'].($moderators ? "<br>\n".$locale['411'].$moderators."</span></td>\n" : "</span></td>\n")."
...
</td><td align='left' valign='bottom' class='forum'>
