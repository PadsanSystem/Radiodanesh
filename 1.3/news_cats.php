...
if (isset($cat_id)) {
	...
	if (dbrows($result) || $cat_id == 0) {
		...
		if ($rows) {
			...
			while ($data2 = dbarray($result2)) {
				echo "<img src='".THEME."images/bullet.gif' alt=''> <a href='index.php?readmore=".$data2['news_id']."'>".$data2['news_subject']."</a><br>\n";
			}
	...
	if (dbrows($result)) {
		...
		while ($data = dbarray($result)) {
			echo "<img src='".THEME."images/bullet.gif' alt=''> <a href='index.php?readmore=".$data['news_id']."'>".$data['news_subject']."</a><br>\n";
		}
		$res = 1;
