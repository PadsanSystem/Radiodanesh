...
<td width='1%' class='tbl1' style='white-space:nowrap'><b>".$locale['u023']."</b></td>
<td class='tbl1'>".($data['user_first_name'] ? $data['user_first_name'] : $locale['u048'])."</td>
</tr>
<tr>
...
<td class='tbl2'>";
	if ($data['user_birthdate'] != "0000-00-00") {
		...
		echo $user_birthdate['2'];
		echo " / ";
		echo $months[number_format($user_birthdate['1'])];
		echo " / ";
		echo $user_birthdate['0'];
	} else {
		echo $locale['u048'];
	}
	echo "</td>
