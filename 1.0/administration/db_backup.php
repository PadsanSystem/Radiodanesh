...
<input class='textbox' dir='ltr' type='text' name='restore_tblpre' value='$info_tblpref' style='width:150px'>
</td>
</tr>
<tr>
<td valign='top' class='tbl'>".$locale['433']."<br>
<select style='width:180px;' dir='ltr' class='textbox' id='list_tbl' name='list_tbl[]' size='$maxrows' multiple>".$table_opt_list."</select>
...
<select style='width:180px;' dir='ltr' class='textbox' id='list_ins' name='list_ins[]' size='$maxrows' multiple>".$insert_opt_list."</select>
...
<table align='center' cellspacing='0' cellpadding='0'>
<tr>
<td colspan='2' class='tbl2' align='right'>".$locale['451']."</td>
</tr>
<tr>
...
<td align='right' dir='ltr' class='tbl'>".$db_prefix."</td>
</tr>
<tr>
<td align='right' class='tbl'>".$locale['452']."</td>
<td dir='ltr' align='right' class='tbl'>".parseByteSize(get_database_size(),2,false)." (".get_table_count()." ".$locale['419'].")</td>
</tr>
<tr>
<td align='right' class='tbl'>".$locale['453']."</td>
<td dir='ltr' align='right' class='tbl'>".parseByteSize(get_database_size($db_prefix),2,false)." (".get_table_count($db_prefix)." ".$locale['419'].")</td>
</tr>
<tr>
<td align='right' colspan='2' class='tbl2'>".$locale['454']."</td>
</tr>
<tr>
