...
if (isset($_POST['save'])) {
	...
	if ($_POST['panel_filename'] == "none") {
		$panel_filename = "";
		$iii = $_POST['panel_content'];
		$panel_content = "opensidex(\"".$panel_name."\");"."echo\"$iii\";"."closesidex();";
		eval("?>".$_POST['panel_content']."<?php ");
		$panel_type = "php";
	} else {
...
<td class='tbl'><textarea id='panel_content' name='panel_content' cols='95' rows='15' class='textbox'>$panel_content</textarea></td>
</tr>\n";
