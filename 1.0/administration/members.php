...
if ($step == "add") {
	if (isset($_POST['add_user'])) {
		...
		if ($error == "") {
			$result = dbquery("INSERT INTO ".$db_prefix."users (user_name, user_password, user_email, user_hide_email, user_birthdate, user_aim, user_icq, user_msn, user_yahoo, user_web, user_avatar, user_sig, user_posts, user_joined, user_lastvisit, user_ip, user_rights, user_groups, user_level, user_status) VALUES ('$username', md5('$password1'), '$email', '$hide_email', '0000-00-00', '', '', '', '', '', '', '', '0', '".time()."', '0', '".USER_IP."', '', '', '101', '0')");
