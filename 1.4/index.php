...
<div class="row" align="right">
	...
	<div class="col-lg-6">
		<h3 class="text-active">حامیان ما</h3>
		<br>
		<div class="col-lg-4 pull-left">
			<img src="images/Pooyesh-1.jpg" class="img-thumbnail">
			<img src="images/13792210631.jpg" class="img-thumbnail">
		</div>
		<div class="col-lg-4 pull-left">
		...
		<div class="col-lg-4 pull-left">
			<img src="images/13912537213.jpg" class="img-thumbnail">
			<img src="images/1398251751baner02.jpg" class="img-thumbnail">
		</div>
	</div>
</div>
<?php
...
<div class="row-fluid text-center" style="height:950px;background-color:#f7f7f7">
	<br><br><br><br><br><br>
	<div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
		<div align="center">
			<img data-src="holder.js/300x200" alt="..." class="thumbnail">
			<div class="caption">
				<h4><?php echo $data['news_subject']; ?></h4>
				<h5><?php echo $data['news_news']; ?></h5>
			</div>
		</div>
	</div>
	<div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
