	...
	<div class="container">
		<footer>
			...
			<p class="text-danger">
				...
				&nbsp;&nbsp;&nbsp;
				<a href="<?php echo MODALS.'contactus.php'; ?>" title="تماس با ما" data-toggle="modal" data-target="#contactus_form">تماس با ما</a>
				</small>
			</p>
		</footer>
	</div>
...
<script src="<?php echo INCLUDES.'jquery.blueimp-gallery.min.js'; ?>"></script>
<script src="<?php echo INCLUDES.'bootstrap-image-gallery.min.js'; ?>"></script>
...
?>
<!-- Contactus Modal -->
<div id="contactus_form" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
