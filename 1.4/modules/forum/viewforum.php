...
echo "<br><table cellpadding='0' cellspacing='0' width='100%' class='tbl-border'>
<tr>
<td>
...
<td align='center' width='100' class='tbl2'>".$locale['452']."</td>
<td align='center' width='5%' class='tbl2'>".$locale['453']."</td>
<td align='center' width='5%' class='tbl2'>".$locale['454']."</td>
<td align='center' width='20%' class='tbl2'>".$locale['404']."</td>
</tr>\n";
...
$threadsubject</td>
<td class='tbl2'><a href='".BASEDIR."profile.php?lookup=".$data['thread_author']."'>".$data['user_author']."</a></td>
...
<tr>
<td align='right' class='tbl'>".$locale['540']." <select name='jump_id' class='textbox' onChange=\"jumpForum(this.options[this.selectedIndex].value);\">$forum_list</select></td>\n";
if (iMEMBER && $can_post) {
	echo "<tr><td align='right'>
<br><a href='post.php?action=newthread&amp;forum_id=$forum_id'><img src='".THEME."forum/newthread.gif' alt='".$locale['566']."' style='border:0px;'></a>
</td></tr>\n";
}
echo "</tr>
</table><hr/>\n";
...
<tr>
<td class='tbl1'>
<img src='".THEME."forum/foldernew.gif' alt='".$locale['560']."' style='vertical-align:middle;'> - ".$locale['456']."<br>
