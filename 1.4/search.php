...
if (!isset($stype)) $stype = isset($_POST['stype']) ? $_POST['stype'] : "n";
...
<input type='submit' name='search' value='".$locale['408']."' class='button'></center><br>
<right>
<input type='radio' name='stype' value='n'".($stype == "n" ? " checked" : "")."> ".$locale['402']."
<p>
<input type='radio' name='stype' value='a'".($stype == "a" ? " checked" : "")."> ".$locale['403']."
<p>
...
if ($stext != "" && strlen($stext) >= "3") {
	...
	if ($stype == "a") {
		...
		$rows = dbrows($result);
		if ($rows != 0) {
			echo $rows." ".($rows == 1 ? $locale['410'] : $locale['411']).$locale['430'].":<br><br>\n";
			$result = dbquery(
			...
			while ($data = dbarray($result)) {
				if (eregi($stext, $data['article_subject']) && eregi($stext, $data['article_article'])) {
					...
					echo "<span class='small'>".$subj_c." ".($subj_c == 1 ? $locale['430'] : $locale['430']).$locale['432'].$locale['433'].", ";
					echo $text_c." ".($text_c == 1 ? $locale['430'] : $locale['430']).$locale['432'].$locale['434']."</span><br><br>";
				} elseif (eregi($stext, $data['article_article'])) {
					$text_c = substr_count(strtolower($data['article_article']), strtolower($stext));
					echo "<a href='readarticle.php?article_id=".$data['article_id']."'>".$data['article_subject']."</a><br>\n";
					echo "<span class='small2'>".$locale['040']."<a href='profile.php?lookup=".$data['user_id']."'>".$data['user_name']."</a>\n";
					echo $locale['041'].showdate("longdate", $data['article_datestamp'])."</span><br>\n";
					echo "<span class='small'>".$text_c." ".($text_c == 1 ? $locale['430'] : $locale['430']).$locale['432'].$locale['434']."</span><br><br>";
				} elseif (eregi($stext, $data['article_subject'])) {
					$subj_c = substr_count(strtolower($data['article_subject']), strtolower($stext));
					echo "<a href='readarticle.php?article_id=".$data['article_id']."'>".$data['article_subject']."</a><br>\n";
					echo "<span class='small2'>".$locale['040']."<a href='profile.php?lookup=".$data['user_id']."'>".$data['user_name']."</a>\n";
					echo $locale['041'].showdate("longdate", $data['article_datestamp'])."</span><br>\n";
					echo "<span class='small'>".$subj_c." ".($subj_c == 1 ? $locale['430'] : $locale['430']).$locale['432'].$locale['433']."</span><br>";
				}
			}
		} else {
			echo "<center>0 ".$locale['411'].$locale['430'].".</center>\n";
		}
		closetable();
		...
		if ($rows != 0) {
			echo $rows." ".($rows == 1 ? $locale['412'] : $locale['413']).$locale['430']."<br><br>\n";
			$result = dbquery(
			...
			while ($data = dbarray($result)) {
				...
				if (eregi($stext, $data['news_subject']) && eregi($stext, $data['news_news']) && eregi($stext, $data['news_extended'])) {
					...
					echo "<a href='index.php".$rstart."#news_".$data['news_id']."'>".$data['news_subject']."</a><br>\n";
					echo "<span class='small2'>".$locale['040']."<a href='profile.php?lookup=".$data['user_id']."'>".$data['user_name']."</a>\n";
					echo $locale['041'].showdate("longdate", $data['news_datestamp'])."</span><br>\n";
					echo "<span class='small'>".$subj_c." ".($subj_c == 1 ? $locale['430'] : $locale['430']).$locale['432'].$locale['435'].", ";
					echo $text_c." ".($text_c == 1 ? $locale['430'] : $locale['430']).$locale['432'].$locale['436'].", ";
					echo $text_c2." ".($text_c2 == 1 ? $locale['430'] : $locale['430']).$locale['432'].$locale['437']."</span><br><br>";
					...
					echo $locale['041'].showdate("longdate", $data['news_datestamp'])."</span><br>\n";
					echo "<span class='small'>".$subj_c." ".($subj_c == 1 ? $locale['430'] : $locale['430']).$locale['432'].$locale['435'].", ";
					echo $text_c." ".($text_c == 1 ? $locale['430'] : $locale['430']).$locale['432'].$locale['436']."</span><br><br>";
					...
					echo "<a href='index.php?readmore=".$data['news_id']."'>".$data['news_subject']."</a><br>\n";
					echo "<span class='small2'>".$locale['040']."<a href='profile.php?lookup=".$data['user_id']."'>".$data['user_name']."</a>\n";
					echo $locale['041'].showdate("longdate", $data['news_datestamp'])."</span><br>\n";
					echo "<span class='small'>".$subj_c." ".($subj_c == 1 ? $locale['430'] : $locale['430']).$locale['432'].$locale['435'].", ";
					echo $text_c." ".($text_c == 1 ? $locale['430'] : $locale['430']).$locale['432'].$locale['437']."</span><br><br>";
					...
					echo "<span class='small2'>".$locale['040']."<a href='profile.php?lookup=".$data['user_id']."'>".$data['user_name']."</a>\n";
					echo $locale['041'].showdate("longdate", $data['news_datestamp'])."</span><br>\n";
					echo "<span class='small'>".$text_c." ".($text_c == 1 ? $locale['430'] : $locale['430']).$locale['432'].$locale['436'].", ";
					echo $text_c2." ".($text_c2 == 1 ? $locale['430'] : $locale['430']).$locale['432'].$locale['437']."</span><br><br>";
					...
					echo "<span class='small2'>".$locale['040']."<a href='profile.php?lookup=".$data['user_id']."'>".$data['user_name']."</a>\n";
					echo $locale['041'].showdate("longdate", $data['news_datestamp'])."</span><br>\n";
					echo "<span class='small'>".$text_c." ".($text_c == 1 ? $locale['430'] : $locale['430']).$locale['432'].$locale['436']."</span><br><br>";
				} elseif (eregi($stext, $data['news_extended'])) {
					$text_c = substr_count(strtolower($data['news_extended']), strtolower($stext));
					echo "<a href='index.php?readmore=".$data['news_id']."'>".$data['news_subject']."</a><br>\n";
					echo "<span class='small2'>".$locale['040']."<a href='profile.php?lookup=".$data['user_id']."'>".$data['user_name']."</a>\n";
					echo $locale['041'].showdate("longdate", $data['news_datestamp'])."</span><br>\n";
					echo "<span class='small'>".$text_c." ".($text_c == 1 ? $locale['430'] : $locale['430']).$locale['432'].$locale['437']."</span><br><br>";
			...
			echo "<center>0 ".$locale['413'].$locale['430'].".</center>\n";
		}
		closetable();
		...
		$rows = dbrows($result);
		if ($rows != 0) {
			echo $rows." ".($rows == 1 ? $locale['414'] : $locale['415']).$locale['430'].":<br><br>\n";
			$result = dbquery(
			...
			while ($data = dbarray($result)) {
				if (eregi($stext, $data['post_subject']) && eregi($stext, $data['post_message'])) {
					...
					echo "<span class='small'>".$subj_c." ".($subj_c == 1 ? $locale['430'] : $locale['430']).$locale['432'].$locale['438'].", ";
					echo $text_c." ".($text_c == 1 ? $locale['430'] : $locale['430']).$locale['432'].$locale['439']."</span><br><br>";
				} elseif (eregi($stext, $data['post_message'])) {
					$text_c = substr_count(strtolower($data['post_message']), strtolower($stext));
					echo "<a href='".FORUM."viewthread.php?forum_id=".$data['forum_id']."&amp;thread_id=".$data['thread_id']."&amp;pid=".$data['post_id']."#post_".$data['post_id']."'>".$data['post_subject']."</a><br>\n";
					echo "<span class='small2'>".$locale['040']."<a href='profile.php?lookup=".$data['user_id']."'>".$data['user_name']."</a>\n";
					echo $locale['041'].showdate("longdate", $data['post_datestamp'])."</span><br>\n";
					echo "<span class='small'>".$text_c." ".($text_c == 1 ? $locale['430'] : $locale['430']).$locale['432'].$locale['439']."</span><br><br>";
				} elseif (eregi($stext, $data['post_subject'])) {
					$subj_c = substr_count(strtolower($data['post_subject']), strtolower($stext));
					echo "<a href='".FORUM."viewthread.php?forum_id=".$data['forum_id']."&amp;thread_id=".$data['thread_id']."&amp;pid=".$data['post_id']."#post_".$data['post_id']."'>".$data['post_subject']."</a><br>\n";
					echo "<span class='small2'>".$locale['040']."<a href='profile.php?lookup=".$data['user_id']."'>".$data['user_name']."</a>\n";
					echo $locale['041'].showdate("longdate", $data['post_datestamp'])."</span><br>\n";
					echo "<span class='small'>".$subj_c." ".($subj_c == 1 ? $locale['430'] : $locale['430']).$locale['432'].$locale['438']."</span><br><br>";
				}
			}
		} else {
			echo "<center>0 ".$locale['415'].$locale['430'].".</center>\n";
		}
		closetable();
		...
		$rows = dbrows($result);
		if ($rows != 0) {
			echo $rows." ".($rows == 1 ? $locale['416'] : $locale['417']).$locale['430'].":<br><br>\n";
			$result = dbquery(
				"SELECT td.*,tdc.* FROM ".$db_prefix."downloads td
				INNER JOIN ".$db_prefix."download_cats tdc ON td.download_cat=tdc.download_cat_id
				WHERE ".groupaccess('download_cat_access')." AND (download_title LIKE '%$stext%' || download_description LIKE '%$stext%')
...
<font class='alt'>".$locale['454']."</font> ".showdate("l j F Y", $data['download_datestamp'])." |
<font class='alt'>".$locale['455']."</font> ".$data['download_count']."</span>\n";
				if ($i != $numrows) { echo "<br><br>\n"; } else { echo "\n"; }
				$i++;
			}
		} else {
			echo "<center>0 ".$locale['417'].$locale['430'].".</center>\n";
		}
		closetable();
		...
		$rows = dbrows($result);
		if ($rows != 0) {
			echo $rows." ".($rows == 1 ? $locale['418'] : $locale['419']).$locale['430'].":<br><br>\n";
			$result = dbquery(
				"SELECT tw.*,twc.* FROM ".$db_prefix."weblinks tw
				INNER JOIN ".$db_prefix."weblink_cats twc ON tw.weblink_cat=twc.weblink_cat_id
				WHERE ".groupaccess('weblink_cat_access')." AND (weblink_name LIKE '%$stext%' || weblink_description LIKE '%$stext%')
			...
			while ($data = dbarray($result)) {
				...
				echo "<span class='small'><font class='alt'>".$locale['451']."</font> ".showdate("l j F Y", $data['weblink_datestamp'])." |
<span class='alt'>".$locale['456']."</span> ".$data['weblink_count']."</span>";
				echo ($i != $numrows ? "<br><br>\n" : "\n"); $i++;
			}
		} else {
			echo "<center>0 ".$locale['419'].$locale['430'].".</center>\n";
		}
		closetable();
		...
		if ($rows != 0) {
			echo $rows." ".($rows == 1 ? $locale['420'] : $locale['421']).$locale['430'].":<br><br>\n";
			...
			echo "<center>0 ".$locale['421'].$locale['430'].".</center>\n";
		}
		closetable();
	}
}
